...
-- 🔥 FIX: JOIN KE DETAIL PART (IDENTITY BENAR)
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?= $summary['part_code'] ?> - <?= $summary['part_name'] ?></td>
        </tr>
        ...
        <tr>
            ...
            <td><?= date("d M Y", strtotime($summary['incoming_date'])) ?></td>
        </tr>
        ...
        <tr>
            ...
            <th class="header">Ref Product</th>

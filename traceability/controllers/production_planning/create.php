...
");
    ...
    $existing = $checkPP->fetch(PDO::FETCH_ASSOC);

    if ($existing) {
        throw new Exception("Planning sudah ada pada tanggal $productionDate");
    }
    ...
    setAlert('error', 'Gagal', 'Production planning gagal tersimpan', 'danger', 'OK');
    redirect('pages/production_planning/create.php');
}

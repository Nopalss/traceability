        ...
        <div class="card shadow-sm trace-card">
            ...
            <div class="card-header d-flex justify-content-between">
                ...
                <?php if ($lot && $data) { ?>
                    ...
                    <a href="export_material_trace.php?lot=<?= urlencode($lot) ?>"
                            ...
                            <tbody>
                                ...
                                <?php foreach ($data as $r) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><b><a href="<?= BASE_URL ?>pages/production_traceability/detail.php?product=<?= $r['product_code'] ?>&date=<?= date('Y-m-d', strtotime($r['created_at'])) ?>&serial=<?= $r['serial_no'] ?>"><?= $r['serial_no'] ?></a></b></td>
